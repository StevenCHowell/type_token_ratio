...
A stand-alone MacOS application is available.  To download this, navigate to [this page](https://github.com/StevenCHowell/type_token_ratio/blob/master/mac_app/ttr.zip) then select the "Download" button on the upper right side.  More information regarding its use will follow.
