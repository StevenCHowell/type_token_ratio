...
A stand-alone MacOS application is available.  To download this, navigate to [this page](https://github.com/StevenCHowell/type_token_ratio/blob/0437ea9eed670a67d8aeeaa6aa685c35a2b83d4e/mac_app/ttr.zip) then select the "Download" button on the upper right side.  More information regarding its use will follow.
