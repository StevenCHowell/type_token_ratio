...
A stand-alone application is was recently made available.  To download this, click on the appropriate link, [Mac](https://github.com/StevenCHowell/type_token_ratio/raw/master/mac_app/ttr), [Windows](https://github.com/StevenCHowell/type_token_ratio/raw/master/win_app/ttr.exe), or [Linux](https://github.com/StevenCHowell/type_token_ratio/raw/master/linux_app/ttr).  Once the file downloads, you should be able to double-click on the resulting file to run the application.  More information regarding its use will follow.
